...
export const SERVICES: Service[] = [
  ...
  },
  {
    id: 'boya-koruma',
    title: 'Pasta Cila',
    description: 'Aracınızın boyasını profesyonel pasta ve cila uygulaması ile derinlemesine temizleyip parlatıyoruz.',
    icon: '✨',
    features: [
      'Derinlemesine temizlik',
      'Profesyonel parlatma',
      'Mat izlerin giderilmesi',
      'Ayna gibi parlak yüzey',
    ],
  },
  {
    id: 'lokal-boya',
    title: 'Kasko Sigorta Anlaşmalı Hasar Düzeltme',
    description: 'Hasar düzeltme işlemlerinizi sigortanız üzerinden hızlıca hallediyoruz.',
    icon: '🤝',
    features: [
      'Sigorta evrak işlemleri',
      'Anlaşmalı kurumlar',
      'Eksperlik hizmeti',
      'Garantili onarım',
    ],
